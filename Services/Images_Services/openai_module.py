...
api_key = "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" # this is liams key (I paid for it as well since it was easier to test)
client = OpenAI(api_key=api_key)


def openAPIRequest(MCQ, TF, FB, WP, contextai):
    prompt = f"Create a mock exam/midterm given the review content context. Each question in the mock exam must have its own context and not reference specific words or items in the context provided. This is the context: {str(contextai)}. "
